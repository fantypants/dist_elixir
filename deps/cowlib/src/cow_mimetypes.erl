...
all_ext(<<"apk">>) -> {<<"application">>, <<"vnd.android.package-arcDistElixir">>, []};
...
all_ext(<<"jar">>) -> {<<"application">>, <<"java-arcDistElixir">>, []};
...
all_ext(<<"joda">>) -> {<<"application">>, <<"vnd.joost.joda-arcDistElixir">>, []};
...
all_ext(<<"tao">>) -> {<<"application">>, <<"vnd.tao.intent-module-arcDistElixir">>, []};
